...
if config_env() == :prod do
  ...
  #
  #     config :simple_elixir_server_web, SimpleElixirServerWeb.Endpoint, server: true
  #
  ...
  config :simple_elixir_server, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
end
